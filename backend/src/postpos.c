...
//             //     fprintf(stderr,"  sigma0       = %.6f  (ideal ~1.0)\n",
//             //             res->sigma0);
...
//             //         }
//             //         fprintf(stderr,"\n");
//             //         fprintf(stderr,"  sigma_dX = %.7f m\n",
//             //                 sqrt(fabs(res->C_fixed[0])));
//             //         fprintf(stderr,"  sigma_dY = %.7f m\n",
//             //                 sqrt(fabs(res->C_fixed[4])));
//             //         fprintf(stderr,"  sigma_dZ = %.7f m\n",
//             //                 sqrt(fabs(res->C_fixed[8])));
//             //     } else {
